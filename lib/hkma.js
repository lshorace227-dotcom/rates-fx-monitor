...
// 注意：HKMA API 受阿里云 WAF 保护，脚本/服务端访问可能被挑战挂起；故 fetch 带 5s 超时，
// 由上层在超时/失败时回退到本地 data/hibor.json（见 series-service.js）。
...
export async function fetchHkma(field, { id, label, meta, pagesize = 365, timeoutMs = 5000 }) {
