...
export const REGISTRY = [
  ...
  // —— 利率：香港 HIBOR 隔夜/1M（HKMA 实时，免 key，失败回退 data/hibor.json）——
  { id: "HIBOR_ON", label: "HIBOR 隔夜", group: "利率", source: "hkma", config: { field: "hibor_overnight" }, unit: "%", freq: "daily", caveat: null },
  { id: "HIBOR_1M", label: "HIBOR 1M",   group: "利率", source: "hkma", config: { field: "hibor_fixing_1m" }, unit: "%", freq: "daily", caveat: null },
  // —— HIBOR 3M/12M：HKMA 免费 API 不含，转本地手动维护（data/hibor.json）——
  { id: "HIBOR_3M", label: "HIBOR 3M",   group: "利率", source: "local", config: { file: "hibor.json", key: "HIBOR_3M" },  unit: "%", freq: "daily", caveat: "HKMA 免费API无3M，本地手动更新" },
  { id: "HIBOR_12M",label: "HIBOR 12M",  group: "利率", source: "local", config: { file: "hibor.json", key: "HIBOR_12M" }, unit: "%", freq: "daily", caveat: "HKMA 免费API无12M，本地手动更新" },
  // —— 利率：中国（本地维护）——
